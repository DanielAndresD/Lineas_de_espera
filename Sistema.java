...
public abstract class Sistema {
    ...
    */
    ...
    public abstract String pk(int n);
    public String toString(){
        return ("Datos del sistema:\n"+
                "\t M:"+this.lambda+"/M:"+this.miu+"/"+this.servidores+"/"+this.poblacion+"/"+this.capacidad_sistema+"\n"+
                "\t Tiempo entre arrivos(λ):"+this.lambda+" cl/ut"+"\n"+
                "\t Tiempo de servicio(μ):"+this.miu+" cl/ut"+"\n"+
                "\t Número de servidores(s):"+this.servidores+" cl/ut"+"\n"+
                "\t Factor de utilización del sistema(ρ):"+this.ro+" cl/ut"+"\n"      
                );
